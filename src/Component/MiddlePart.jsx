    ...
    <div>
      ...
      <div className=" flex gap-10 my-8">
        ...
        <div>
          ...
          <div className=" flex justify-center items-center gap-4">
            <button className=" bg-transparent border border-black px-3 hover:border-orange-400 hover:text-orange-400">
              M
            </button>
            <button className=" bg-transparent border border-black px-3 hover:border-orange-400 hover:text-orange-400">
              L
        ...
        <div>
          ...
          <div className=" flex justify-center items-center gap-1">
            <button
              ...
              disabled={count === 0}
              className={`bg-${
                count === 0 ? "gray-50" : "gray-200"
              } text-2xl m-0 py-0 px-3 flex justify-center items-center `}
            >
              -
            </button>
            <h1 className="border border-gray-200 text-2xl py-0 px-3 m-0">
              {count}
            </h1>
            <button
              onClick={increment}
      ...
      <div className="flex lg:flex-row flex-col justify-center items-center gap-5 px-2">
        <button className=" bg-sky-400 w-full text-3xl text-white py-2">
          Buy Now
        </button>
        <button className=" w-full text-3xl text-white py-2 bg-orange-400">
          Add to Cart
        </button>
      </div>
    </div>
